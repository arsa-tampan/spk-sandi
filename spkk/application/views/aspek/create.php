...
<div class="card shadow mb-4">
	...
	<?php echo form_open('Aspek/store'); ?>
		<div class="card-body">
			<div class="row">
				...
				<div class="form-group col-md-6">
					...
					<input autocomplete="off" type="number" name="persentase" required class="form-control"/>
				</div>
				
				<div class="form-group col-md-6">
					<label class="font-weight-bold">Bobot Core Factor (%)</label>
					<input autocomplete="off" type="number" name="bobot_cf" required class="form-control"/>
				</div>
				
				<div class="form-group col-md-6">
					<label class="font-weight-bold">Bobot Secondary Factor (%)</label>
					<input autocomplete="off" type="number" name="bobot_sf" required class="form-control"/>
				</div>
			</div>
		</div>
